...
>(
  (
    ...
    // internal desktop open state (can be controlled from outside)
    ...
    const setOpen = React.useCallback(
      (value: boolean | ((value: boolean) => boolean)) => {
        ...
        try {
          ...
          /* ignore server-side or restricted cookie environment */
        }
      },
      [setOpenProp, open]
    )
...
>(
  (
    ...
    // desktop: we will explicitly set width/minWidth via inline style when collapsed
    return (
      <div
        ref={ref}
      ...
      >
        ...
        >
          <div
            ...
            // internal container should always be full width of parent
            style={{ minWidth: 0 }}
          >
            {children}
          </div>
